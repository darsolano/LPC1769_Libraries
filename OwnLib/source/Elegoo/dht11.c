...
#define DHT11_START_SIGNAL_TIME			18	// millisenconds
...
static void dht11_read_data_frame(DHT11_t* DHTx){
	...
	}while (getTimer0_counter() < DHT11_START_SIGNAL_TIME*1000);
	curr_time = stopTimer0();
#if DHT11_DEBUG
...
Bool dht11_Init(DHT11_t* DHTx, uint8_t port, uint8_t pin){
	...
	xprintf("LPC1769 lpcXpresso BaseBoard - DHT11 test app...\n");
#endif
