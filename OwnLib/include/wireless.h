...
//Data Structure to hold the value of all registers
// must be read with function - NRF24L01_get_all_registers -
typedef struct _nrf24l01p_regs
{
	uint8_t sCONFIG;
	uint8_t sEN_AA;
	uint8_t sEN_RXADDR;
	...
	uint8_t sOBSERVE_TX;
	uint8_t sCD;
	uint8_t sRX_ADDR_P0[5];
	uint8_t sRX_ADDR_P1[5];
	uint8_t sRX_ADDR_P2;
	uint8_t sRX_ADDR_P3;
	uint8_t sRX_ADDR_P4;
	uint8_t sRX_ADDR_P5;
