...
*/
#ifndef INCLUDE_UBX_H_
#define INCLUDE_UBX_H_
...
typedef struct GPS_UBX_HEAD_s
{
	...
	U1* payload;				//!< Payload buffer pointer
	U2 chksum;					//!< calculated checksum for the message
...
This message from the receiver acknowledges successful processing of a previously received chunk of data with the ìChunk Transferî Message. This message will also be sent once a ìStopî message has been received, and the integrity of all chunks received so far has been checked successfully.
...
This message from the receiver indicates that an error has occurred while processing and storing the data received with the ìChunk Transferî message. This message will also be sent once a stop command has been received, and the integrity of all chunks received failed.
