...
/*
 * SPI or Serial Bitbang
 */
#define SPI				1
#define BITBANG			0


// AS per electronic Schematic Diagram
#define TFT32_LCD_RS	0x01
#define TFT32_LCD_WR	0x02
#define TFT32_LCD_CS	0x04
#define TFT32_LCD_RST	0x08
#define TFT32_LCD_LED	0x10
